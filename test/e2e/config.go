package e2e
    ...
    // DeleteImage is a placeholder function demonstrating a common action.
    // In a real implementation, this would contain complex logic.
    func (s *Image) DeleteImage(w io.Writer) error {
        // TODO: Implement the core logic for this operation.
        fmt.Fprintf(w, "Processing Image with action Delete\n")
        return nil
    }
